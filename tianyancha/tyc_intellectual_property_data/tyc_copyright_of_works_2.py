...
def create_json(pageNum, info_id, tyc_id, company_name, res_json):
    folder_name = os.getcwd() + "/jsondata/tyc_作品著作权_file/"
    ...
    logger.debug(("--ttyc_作品著作权_file__写入到-->" + file_nm))
    ...
    try:
        ...
        for ite in items_list:
            item = {
                ...
                "fullname": ite.get("fullname", ""),
                "authorNationality": ite.get("authorNationality", ""),
                "publishtime": ite.get("publishtime", ""),
                "regtime": ite.get("regtime", ""),
                "id": ite.get("businessId", ""),
