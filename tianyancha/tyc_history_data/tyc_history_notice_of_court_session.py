    ...
    try:
        ...
        for re in res_json["data"]["resultList"]:
            item = {
                ...
                "info_id": info_id,
                "area": re.get("area", ""),
                "plaintiff": str(re.get("plaintiff", "")).replace("'", '"') if re.get("plaintiff") is not None else "",
                ...
                "litigant2": str(re.get("litigant2", "")).replace("'", '"') if re.get("litigant2") is not None else "",
                "courtroom": re.get("courtroom", ""),
                "defendant": str(re.get("defendant", "")).replace("'", '"') if re.get("defendant") is not None else "",
