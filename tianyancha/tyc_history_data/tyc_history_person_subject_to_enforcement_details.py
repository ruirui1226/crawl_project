...
# -*- coding: utf-8 -*-
"""
@Time : 2023/5/16 13:46
@Author : zhangpf
@File : tyc_history_person_subject_to_enforcement_details.py
@Desc : 历史被执行人详情
@Software: PyCharm
"""
...
def create_json(info_id, tyc_id, company_name, res_json):
    ...
    logger.debug(("--ttyc_历史法院公告详情_file__写入到-->" + file_nm))


def get_authoriaztion(info_id, company_name, tyc_id, businessId):
    version = "Android 12.67.0"
    url = HISTORY_PERSON_SUBJECT_TO_ENFORCEMENT_DETAILS
...
def get_person_subject_to_enforcement_info(info_id, company_name, tyc_id, businessId):
    try:
        ...
        data = {"cgid": tyc_id, "detailId": businessId, "type": "zhixinginfo"}
        url = HISTORY_PERSON_SUBJECT_TO_ENFORCEMENT_DETAILS
