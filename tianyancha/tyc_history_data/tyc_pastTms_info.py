...
def create_json(pageNum, info_id, tyc_id, company_name, res_json):
    folder_name = os.getcwd() + "/tyc_pastTms_file_历史商标信息/"
    ...
    logger.debug(("--tyc_pastTms_file_file__写入到-->" + file_nm))


def get_authoriaztion(info_id, company_name, tyc_id, pageNum):
    version = "Android 11.4.0"

    url = "https://api4.tianyancha.com/services/v3/trademark/pastTms.json"
...
def get_pastTms_page(info_id, company_name, tyc_id, tyc_hi, Authorization, duid, deviceID):
    try:
        headers = {
...
def get_pastTms_info(info_id, company_name, tyc_id, pageNum):
    try:
        url = "https://api4.tianyancha.com/services/v3/trademark/pastTms.json"
...
def main():
    ...
    for data in data_list:
        ...
        pages_total = get_pastTms_page(info_id, company_name, tyc_id, tyc_hi, Authorization, duid, deviceID)
        if pages_total:
            print(company_name)
            for pageNum in range(1, int(pages_total) + 1):
                get_pastTms_info(info_id, company_name, tyc_id, pageNum)
