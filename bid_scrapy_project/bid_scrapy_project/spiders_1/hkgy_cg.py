...
class HkgyCgSpider(scrapy.Spider):
    name = 'hkgy_cg'
    ...
    def __init__(self):
        self.infoType = {
            "招标公告": "https://ebid.eavic.com/cms/channel/ywgg1/index.htm?pageNo=1",
            "变更公告": "https://ebid.eavic.com/cms/channel/ywgg2/index.htm?pageNo=1",
            "中标公示": "https://ebid.eavic.com/cms/channel/ywgg3/index.htm?pageNo=1",
            "中标结果公告": "https://ebid.eavic.com/cms/channel/ywgg4/index.htm?pageNo=1",
        }
    ...
    def parse(self, response):
        ...
        for li in list:
            ...
            # 文章标题
            title = li.xpath('./a/span/text()').extract_first().strip()
            # 文章发布时间
    ...
    def getContentInfo(self, response):
        ...
        items_infos['website_name'] = "航空工业电子招投标平台"
        items_infos['website_url'] = "https://ebid.eavic.com/cms/channel/ywgg1/index.htm"
